...
<div class="row main">
        ...
        <div class="topic panel panel-default">
            <div class="infos panel-heading">
                <div class="entry-header pos-r">
                    <#if view.thumbnail?? && view.thumbnail?length gt 0>
                    <div class="img-bg" style="background-image:url('<@resource src=view.thumbnail/>')"></div>
                        <div class="topics-one">
                            <div class="post-views pos-a l1 shadow">
                                <abbr><i class="icon icon-fire"></i>
                                    <span class="counter-values">${view.views}</span><span>°</span>
                                </abbr>
                            </div>
                        </div>
                    <#else>
                    <div class="img-bgs"></div>
                        <div class="topics-ones">
                            <div class="post-viewss pos-a l1 shadow">
                                <abbr><i class="icon icon-fire"></i>
                                    <span class="counter-value">${view.views}</span><span>°</span>
                                </abbr>
                            </div>
                        </div>
                    </#if>
                ...
                <div class="post-meta">
                    <div class="single-post-meta pos-r fs13 topics-three">
                        <span><@utils.showAva view.author "img-circle"/></span>
                        <div class="single-user-meta">
                            ...
                            <div class="post-r-meta"><span class="mobile-hide">发表于：</span>
                                <time  class="timeago">${view.created}</time>
                                <span class="dot"></span>
                            </div>
                            <div class="pos-a single-add-follow">
    ...
    <div class="col-xs-12 col-md-3 side-right hidden-xs hidden-sm">
		...
		<@sidebar method="hottest_posts" size=6>
    ...
    <li id="chat{5}">
        ...
        <div class="chat_body">
            <h5>
                ...
                <div class="fr reply_this"><a href="javascript:void(0);" onclick="goto('{5}', '{2}')">回复 <i class="icon icon-action-redo"></i></a></div>
                <div class="clear"></div>
            </h5>
            <div class="chat_p">
