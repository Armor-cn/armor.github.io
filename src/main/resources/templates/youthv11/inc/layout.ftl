...
<head>
    ...
    <link href="${base}/theme/youthv11/dist/viewer/css/viewer.min.css" rel="stylesheet"/>
    <link href="${base}/theme/youthv11/dist/css/swiper.min.css" rel="stylesheet"/>
    <link href="${base}/theme/youthv11/dist/css/style.css" rel="stylesheet"/>
    <link href="${base}/theme/youthv11/dist/css/banner.css" rel="stylesheet"/>
    ...
    <script src="${base}/theme/youthv11/dist/viewer/js/viewer.min.js"></script>
...
<body>
    <!-- header -->
    <#include "/youthv11/inc/header.ftl"/>
    <!-- /header -->
    ...
    <!-- footer -->
    <#include "/youthv11/inc/footer.ftl"/>
</body>
</html>
</#macro>